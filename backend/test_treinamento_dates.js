...
async function runTest() {
    try {
        console.log('--- TEST: CREATE NEW TRAINING ---');
        const createPayload = {
            forma_treinamento: 'Presencial',
            titulo: 'Test Training Dates ' + Date.now(),
            obs_treinamento: 'Check creation and update dates integrity',
        ...
        const updatePayload = {
            ...
            forma_treinamento: 'Presencial',
            titulo: 'Updated Test Training ' + Date.now(),
            obs_treinamento: 'Check creation and update dates integrity - UPDATED',
            qualifica_para: 'Colaborador Adoção Espiritual',
        ...
        console.log('\nALL TRAINING DATE INTEGRITY TESTS PASSED!');
        process.exit(0);
    } catch (e) {
